...
export function HeroVideoBanner({ videoRef, posterImage, title, subtitle, primaryCta, secondaryCta }: HeroVideoBannerProps) {
  const fallbackImage = posterImage ?? "/images/hero-fight.jpg";
  const hasVideo = videoRef && !videoRef.includes("placeholder") && !videoRef.includes("storage.googleapis.com/coach-demo");
